...
public class KekoTest {
    ...
    private Keko keko2;
    private int isoLuku;
    private int heapDelMinSuhde;
    private double heapInsertSuhde;
    ...
    /**
     * Oma keko toimii (yleensä) nopeammin tässä kuin javan priorityQueue!
     */
    @Test
    public void lisaamisenAikaSuhdeVertailu() {
        PriorityQueue<Koordinaatti> javaKeko = new PriorityQueue<Koordinaatti>(1, new KoordinaattiComparator());
        Keko omaKeko = new Keko(100000);
        ...
        assertTrue("Ois ollu: " + (omaTulos / javanTulos), (omaTulos / javanTulos) < heapInsertSuhde);
    }
    ...
    @Test
    public void heapDelMinAikaSuhde() {
        PriorityQueue<Koordinaatti> javaKeko = new PriorityQueue<Koordinaatti>(1, new KoordinaattiComparator());
        Keko omaKeko = new Keko(isoLuku);
        //Alustetaan javan priorityQueue koordinaateilla, tämän aika on testattu jo edellisessä.
        for (int i = 0; i < isoLuku / 3; i++) {
        ...
        assertTrue("Ois ollu: " + (omaTulos / javanTulos), (omaTulos / javanTulos) < heapDelMinSuhde);
    }

    @Test
    public void heapDelMinAikaSuhdePienemmallaSyotteella() {
        PriorityQueue<Koordinaatti> javaKeko = new PriorityQueue<Koordinaatti>(1, new KoordinaattiComparator());
        Keko omaKeko = new Keko(isoLuku);
        //Alustetaan javan priorityQueue koordinaateilla, tämän aika on testattu jo edellisessä.
        for (int i = 0; i < isoLuku/10 ; i++) {
            Koordinaatti testi = new Koordinaatti(1, 1, i, 'g');
            javaKeko.add(testi);
        }
        //Alustetaan oma keko koordinaateilla, tämän aika on myös testattu jo edellisessä.
